...
1. clone package [git clone https://github.com/developer-ashok/laravel-firebase-realtime.git]
2. install composer dependency [composer install]
3. create account in firebase and copy credentials json
4. run laravel application using. [php artisan serve]
7. run your application using [YOUR_LOCAL_PROJECT_URL/]

<a href="https://codescompanion.com/">Read more.. Firebase RealTime Integration Laravel-5-x</a>.
